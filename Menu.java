        ...
        jButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (jRadioButton2.isSelected()) {
                    frame.setVisible(false);
                    Timetable_page o = new Timetable_page();
                }


                if (jRadioButton3.isSelected()) {
                    frame.setVisible(false);
                    Checking_Attendance o = new Checking_Attendance();
                }


                if (jRadioButton5.isSelected()) {
                    frame.setVisible(false);
                    Showing_Student_details_page o = new Showing_Student_details_page();
                }
                ...
                if (jRadioButton1.isSelected()) {
                    frame.setVisible(false);
                    Showing_Lectures_details_Page o = new Showing_Lectures_details_Page();
                }
